...
/*
assume that there is never more than one character of pushback.  modify getch, ungetch accordingly.
*/
...
int pushed; // buffer variable for getch and ungetch
int has_pushed;

int getch(void) {
  return (has_pushed) ? pushed : getchar();
}
